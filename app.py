...
# picnicItems = {'sandwiches': 4, 'apples': 12, 'cups': 4, 'cookies': 8000, 'plates': 42, 'bottles of wine': 69, 'glasses': 4}
# printPicnic(picnicItems, 12, 5)
# printPicnic(picnicItems, 20, 15)


spam = 'SpamSpamBaconSpamEggsSpamSpam'
print(spam.strip('ampS'))               #the order of elements you want striped from the ends doesnt matter, will remove in any order
